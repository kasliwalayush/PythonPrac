...
class S3:
    def download_files_from_s3(bucket_name, job_id, destination_folder):
        ...
        input_folder_prefix =  #location
        output_folder_prefix = #location
    ...
    def download_and_move_files_from_job_ids(bucket_name, file_path, destination_folder):
        ...
        for job_id in job_ids:
            bucket_name.download_files_from_s3(bucket_name, job_id, destination_folder)
...
Object = S3()
Object.download_files_from_s3()
Object.move_files_to_job_folder()
Object.download_and_move_files_from_job_ids()

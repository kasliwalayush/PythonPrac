...
def upload_zip_to_postman(job_id, api_key, api_key1):
    ...
    input_folder_path = f'H:\\iCodex\\eAssistant Packages\\testTNQ\\{job_id}\\input'
...
for job_folder in os.listdir(root_directory):
    ...
    if os.path.isdir(job_folder_path):
        upload_zip_to_postman(job_folder, api_key, api_key1)
